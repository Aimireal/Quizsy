...
final List<Category> categories = [
  ...
  Category(20,"Mythology", icon: FontAwesomeIcons.atlassian),
  ...
  Category(26,"Celebrities", icon: FontAwesomeIcons.award),
  Category(27,"Animals", icon: FontAwesomeIcons.dog),
  Category(28,"Vehicles", icon: FontAwesomeIcons.carAlt),
  Category(29,"Comics", icon: FontAwesomeIcons.readme),
  Category(30,"Gadgets", icon: FontAwesomeIcons.mobileAlt),
  Category(31,"Japanese Anime & Manga", icon: FontAwesomeIcons.glasses),
  Category(32,"Cartoon & Animation", icon: FontAwesomeIcons.pencilAlt),
];